...
(function($) {
    ...
    var button = $("#friendlyRead");
    var hdr = $("#header")

    button.click(function() {
        button.toggleClass("fa-toggle-on");
        button.toggleClass("fa-toggle-off");
        $(document.body).toggleClass("color-friendly");
        hdr.toggleClass("color-friendly");
    });
